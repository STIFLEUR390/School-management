                                        ...
                                        <table class="table table-bordered table-striped" style="width: 100%">
                                            ...
                                            <tbody>
                                                @foreach($assignStudents as $key => $assignStudent)
                                                    @php
                                                        $registrationfee = \App\Models\FeeCategoryAmount::where('fee_category_id', '1')->where('class_id', $assignStudent->class_id)->first();
                                                        $color = 'success';
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a class="btn btn-{{ $color }}" title="PaySlip" target="_blank" href="{{ route('student.registration.fee.payslip', ['class_id' => $assignStudent->class_id, 'student_id' => $assignStudent->student_id]) }}">@lang('Fee Slip')</a>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
