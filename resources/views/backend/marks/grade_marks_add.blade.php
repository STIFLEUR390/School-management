            ...
            <section class="content">
                ...
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="box-title">@lang('Add Grade Marks')</h4>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" value="{{ old('grade_point') }}" name="grade_point"
                                                           class="form-control" required />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" value="{{ old('start_marks') }}" name="start_marks"
                                                           class="form-control" required />
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" value="{{ old('end_marks') }}" name="end_marks"
                                                           class="form-control" required />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" value="{{ old('start_point') }}" name="start_point"
                                                           class="form-control" required />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" value="{{ old('end_point') }}" name="end_point"
                                                           class="form-control" required />
                                                </div>
                                            </div>
                                        </div>
