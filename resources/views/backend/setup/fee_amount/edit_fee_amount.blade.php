            ...
            <section class="content">
                ...
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="box-title">@lang('Edit Fee Amount')</h4>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <div class="row">
                            <div class="col">
                                <form method="post" action="{{ route('fee.amount.update', $feeCategoryAmounts[0]->fee_category_id) }}">
                                    @csrf
                                    @method('PUT')
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-5">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="controls">
                                                                    <input type="text" value="{{ $feeCategoryAmount->amount }}"  name="amount[]" class="form-control" required />
                                                                </div>
                                                            </div>
                                                        </div>
