                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        @foreach($feeCategoryAmounts as $key => $feeCategoryAmount)
                                            <tr>
                                                ...
                                                <td width="10%">
                                                    <a href="{{ route('fee.amount.edit', $feeCategoryAmount->id) }}" class="text-info mr-10" data-toggle="tooltip" data-original-title="@lang('Edit')">
                                                        <i class="ti-marker-alt"></i>
                                                    </a>
                                                    <a href="{{ route('fee.amount.destroy', $feeCategoryAmount->id) }}"  class="text-danger delete" data-original-title="@lang('Delete')" data-toggle="tooltip">
                                                        <i class="ti-trash"></i>
                                                    </a>
                                                </td>
                                            </tr>
