                                ...
                                <div class="table-responsive">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        @foreach($asssignStudents as $key => $asssignStudent)
                                            <tr>
                                                <td >{{ $key + 1 }}</td>
                                                <td>{{ $asssignStudent->class_id }}</td>
                                                <td>{{ $asssignStudent->year_id }}</td>
                                                <td width="10%">
                                                    ...
                                                    <a href="{{ route('students.registration.destroy', $asssignStudent->id) }}"  class="text-danger delete" data-original-title="@lang('Delete')" data-toggle="tooltip">
                                                        <i class="ti-trash"></i>
                                                    </a>
                                                </td>
                                            </tr>
