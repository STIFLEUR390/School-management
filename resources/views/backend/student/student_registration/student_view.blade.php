                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <select name="year_id" id="year_id" required class="form-control">
                                                        <option value="" {{ old('year_id') ? '' : 'selected' }} disabled>
                                                            @lang('Select Year')</option>
                                                        @foreach ($studentYears as $year)
                                                            <option
                                                                {{ old('year_id', $year_id) == $year->id ? 'selected' : '' }}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <select name="class_id" id="class_id" required class="form-control">
                                                        <option value=""
                                                            {{ old('class_id', $class_id) ? '' : 'selected' }} disabled>
                                                            @lang('Select Class')</option>
                    ...
                    <div class="col-12">
                        ...
                        <div class="box">
                            <div class="box-header with-border">
                                ...
                                <a href="{{ route('students.registration.create') }}" style="float: right;"
                                    class="mb-5 waves-effect waves-light btn btn-rounded btn-success">
                                        ...
                                        <tbody>
                                            @foreach ($asssignStudents as $key => $asssignStudent)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="{{ !empty($asssignStudent->student->image) ? url('upload/student_images/' . $asssignStudent->student->image) : url('upload/no_image.jpg') }}"
                                                    ...
                                                    @endif
                                                    <td>
                                                        <a href="{{ route('students.registration.edit', $asssignStudent->student_id) }}"
                                                            class="mr-10 text-info" data-toggle="tooltip"
                                                            data-original-title="@lang('Edit')">
                                                            <i class="ti-marker-alt"></i>
                                                        </a>
                                                        <a href="{{ route('students.registration.promotion', $asssignStudent->student_id) }}"
                                                            class="mr-10 text-primary" data-toggle="tooltip"
                                                            data-original-title="@lang('Promotion')">
                                                            <i class="fa fa-check"></i>
                                                        </a>
                                                        <a target="_blank"
                                                            href="{{ route('students.registration.destroy', $asssignStudent->student_id) }}"
                                                            class="text-danger " data-original-title="@lang('Details')"
                                                            data-toggle="tooltip">
                                                            <i class="fa fa-eye"></i>
                                                        </a>
                                                    </td>
