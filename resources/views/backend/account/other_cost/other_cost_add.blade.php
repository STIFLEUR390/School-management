            ...
            <section class="content">
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col">
                                <form method="post" action="{{ route('other.cost.store') }}"
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <textarea name="description" id="description" class="form-control" required="" placeholder="@lang('Textarea text')" aria-invalid="false"></textarea>
