                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <select name="employee_id" id="employee_id" required class="form-control">
                                                        <option value="" {{ old('employee_id') ? '' : 'selected' }} disabled>@lang('Select Employee Name')</option>
                                                        @foreach($employees as $employee)
                                                            <option {{ old('employee_id') ? 'selected' : '' }} value="{{ $employee->id }}">{{ $employee->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <select name="leave_purpose_id" id="leave_purpose_id" required class="form-control">
                                                        <option value="" {{ old('employee_id') ? '' : 'selected' }} disabled>@lang('Select Leave Purpose')</option>
                                                        @foreach($leave_purposes as $leave)
                                                            <option {{ old('employee_id') ? 'selected' : '' }} value="{{ $leave->id }}">{{ $leave->name }}</option>
                                                        @endforeach
